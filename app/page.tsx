  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center px-6 py-12 text-white">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-10">
        <div className="flex items-center gap-2 rounded-full border border-emerald-300/30 bg-emerald-500/15 px-4 py-2 text-sm font-medium text-emerald-200">
          <Zap className="h-4 w-4" />
          Instant AI Analysis
        </div>
        <div className="flex items-center gap-2 rounded-full border border-rose-300/30 bg-rose-500/15 px-4 py-2 text-sm font-medium text-rose-200">
          <Shield className="h-4 w-4" />
          Risk Detection
        </div>
        <div className="flex items-center gap-2 rounded-full border border-violet-300/30 bg-violet-500/15 px-4 py-2 text-sm font-medium text-violet-200">
